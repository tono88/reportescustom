...
class AccountPayment(models.Model):
    ...
    def _partner_arap(self):
        ...
        return partner.property_account_receivable_id if self.is_inbound() else partner.property_account_payable_id
    ...
    def _fix_liquidity_only_entry(self):
        ...
        for payment in self:
            ...
            if not journal.fix_liquidity_only_entry:
                continue
